...
public class DiffUIController : MonoBehaviour
{
    ...
    public void buttonIndicate(int buttonIndex)
    {
        ...
        if (buttonIndex == 0 || buttonIndex == 1 || buttonIndex == 2){
            ...
            diffManager.GetComponent<DiffManager>().setAdd(buttonIndex);
        }
            ...
            diffManager.GetComponent<DiffManager>().setAdd(buttonIndex - 3);
        }
            ...
            diffManager.GetComponent<DiffManager>().setAdd(buttonIndex - 6);
        }
            ...
            diffManager.GetComponent<DiffManager>().setAdd(buttonIndex - 9);
        }
