...
{
    const string privateCode = "fG1Hs0mcC02k9gIZnB3thQViDFw5hBHUi7V-S4HrZ_-g";  //Key to Upload New Info
    const string publicCode = "642b18938f40bb109c047d68";   //Key to download
